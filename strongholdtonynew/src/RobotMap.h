...
public:
	...
	static std::shared_ptr<DigitalInput> ballManipulationBottomLimitSwitch;
	...
	static std::shared_ptr<DigitalInput> ballManipulationTopLimitSwitch;
	static std::shared_ptr<Encoder> ballManipulationPivotEncoder;
