...
BallManipulation::BallManipulation() :
    ...
    bottomLimitSwitch = RobotMap::ballManipulationBottomLimitSwitch;
    ...
    topLimitSwitch = RobotMap::ballManipulationTopLimitSwitch;
    pivotEncoder = RobotMap::ballManipulationPivotEncoder;
...
bool BallManipulation::getBottomSwitchLimit() {
	return bottomLimitSwitch->Get();
}

bool BallManipulation::getTopSwitchLimit() {
	return topLimitSwitch->Get();
}

int BallManipulation::getPivotEncoder() {
